...
interface NoteProjectsListScreenProps {
  navigation: any;
}

export const NoteProjectsListScreen: React.FC<NoteProjectsListScreenProps> = ({
  navigation,
}) => {
  ...
  const handleProjectPress = (project: Project) => {
    navigation.navigate('ProjectNotes', { project });
  };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <ProjectCard
            ...
            taskCount={item.notes?.length || 0}
          />
        )}
        ListEmptyComponent={
          !defaultProject ? (
            <View style={styles.emptyContainer}>
              <Text style={styles.emptyText}>No note projects yet</Text>
