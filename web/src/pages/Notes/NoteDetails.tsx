    ...
    <div className="note ">
      <div className="note-header">
        ...
        <div className="flex mt-1 align-items-center">
          <span>
            Created on <span className="markee">January 23 2023</span>
            <BsDot />
          </span>
          <span>
          ...
          <span>
            Project : <span className="markee bold">Bills</span>
          </span>
        </div>
      </div>
      <div className="note-body">
        ...
        PageMaker including versions of Lorem Ipsum. What is Lorem Ipsum? Lorem
